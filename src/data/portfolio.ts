...
export const services = [
  {
    ...
    description: "Production-ready React, Next.js & TypeScript apps engineered for scale and maintainability.",
  },
  {
    icon: "Rocket",
    title: "Landing Pages",
    description: "Conversion-optimized landing pages that load fast, look stunning, and tell your story.",
  },
  {
    icon: "LayoutDashboard",
    title: "Dashboard Development",
    description: "Complex data dashboards with charts, tables, and real-time updates — built for clarity.",
  },
  {
    icon: "Gauge",
    title: "Website Optimization",
    description: "Core Web Vitals, accessibility, and SEO audits with concrete fixes that move metrics.",
  },
  {
    icon: "Plug",
    title: "API Integration",
    description: "REST, GraphQL, and third-party integrations done right — typed, tested, and documented.",
  },
  {
    icon: "Paintbrush",
    title: "Design Systems",
    description: "Reusable component libraries with tokens, variants, and a11y baked in from day one.",
  },
];
...
export const experience = [
  {
    ...
    company: "Stellar Labs (Remote)",
    period: "2023 — Present",
    description: "Leading the frontend for a B2B analytics platform serving 50k+ users. Architected the design system and mentored 4 engineers.",
  },
  {
    role: "Frontend Developer",
    company: "Orbit Studio",
    period: "2021 — 2023",
    description: "Shipped 20+ client projects across fintech, e-commerce, and SaaS. Reduced average page load by 60%.",
  },
  {
    role: "Freelance Developer",
    company: "Self-employed",
    period: "2020 — 2021",
    description: "Partnered with founders to build MVPs and marketing sites. First taste of the remote-first life.",
  },
  {
    role: "Junior Web Developer",
    company: "Lagos Web Co.",
    period: "2019 — 2020",
    description: "Built responsive websites for local SMBs and learned the craft from senior engineers.",
  },
];

export const testimonials = [
  {
    quote: "Kingsley delivered our dashboard ahead of schedule and the quality blew us away. The animations alone made our investors lean in.",
    name: "Amara Chen",
    role: "CTO, Stellar Labs",
  },
  {
    quote: "Easily the best frontend engineer we've worked with. Clean code, great taste, and zero hand-holding required.",
    name: "Marcus Bauer",
    role: "Founder, Glassflow",
  },
  {
    quote: "We hired Kingsley for a 2-week sprint and ended up keeping him for 6 months. He just gets product.",
    name: "Sofia Almeida",
    role: "Head of Design, Lumen",
  },
  {
    quote: "He took a messy Figma file and turned it into the cleanest React codebase I've ever inherited.",
    name: "Daniel Park",
